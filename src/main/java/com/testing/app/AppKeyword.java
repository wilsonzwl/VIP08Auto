...
//	public void appiumKeyevent() {
//		KeyEvent key = new KeyEvent();
//		driver.pressKey(key.withKey(AndroidKey.BACK));
//	}

//	public void appiumKeyevent(String keycode) {
//		int keynum = Integer.parseInt(keycode);
//		KeyEvent key = new KeyEvent();
//		driver.pressKey(key.withKey(new AndroidKey(keynum)));
//
//	}

	public void appiumKeyevent(AndroidKey adbkey) {
		KeyEvent key = new KeyEvent();
		driver.pressKey(key.withKey(adbkey));
	}
