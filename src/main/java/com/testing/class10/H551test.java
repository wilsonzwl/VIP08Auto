...
public class H551test {
    public static void main(String[] args) {
        ...
        qqcap.setCapability("chromedriverExecutable", "D:\\study\\software\\driver\\chromedriver\\74\\chromedriver.exe");
        ...
        try {
            ...
            driver.findElement(By.id("com.android.browser:id/url")).sendKeys("www.51job.com");
            Thread.sleep(3000);
